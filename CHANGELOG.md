...
- dependencies
- reviewed timestamp issue

## 2026-08-14

### Fixed

- the millisecond epochs in fit files are now properly handled in the csv export. This strange behavior was introduced on 2026-02-28.
